...
class ScanerProducts extends StatefulWidget {
  @override
  _ScanerProductsState createState() => _ScanerProductsState();
}

class _ScanerProductsState extends State<ScanerProducts> {
